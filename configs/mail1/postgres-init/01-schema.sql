-- Schema for a traditional Postfix+Dovecot mail server.
-- Used by SQL lookups in postfix virtual_*_maps and dovecot's auth-sql.conf.
-- Independent of any product-specific ORM; this is the contract between the
-- daemons and the database, nothing more.
